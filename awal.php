                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-hover table-bordered" id="mytable" style="margin-top: 10px">
                                ...
                                <?php
                                    $no=1;
                                    $hasil = $proses->tampil_data('sms');
                                    foreach($hasil as $isi){
                                ?>
                                    <tr>
                                        <td><?php echo $no; ?></td>
                                        <td><?php echo $isi['teks']?></td>
                                        <td><?php echo $isi['label'];?></td>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <a onclick="return confirm('Apakah yakin data akan di hapus?')" href="core/crud.php?aksi=hapus&hapusid=<?php echo $isi['id_login'];?>" 
